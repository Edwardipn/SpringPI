...
public class EmpleadosMain {
	...
	public static void main(String[] args) {
		...
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("ApplicationContext9DIConstruc.xml");
		IEmpleados Javier = context.getBean("empleadoBean", IEmpleados.class);
